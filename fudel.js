...
$(document).ready(function() {
	(function(e) {
		...
		e.get(t.attr("href"), function(n) {
			t.html(
				' <strong> Next <i class="lnr lnr-arrow-right"></i></strong><br/><div class="post-pager-title"><span>' +
				e(n).find(".post .post-title").text() + '</span></div>')
		}, "html");
		e.get(n.attr("href"), function(t) {
			n.html(
				'<strong><i class="lnr lnr-arrow-left"></i> Previous </strong><br/><div class="post-pager-title"><span>' +

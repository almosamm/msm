...
$(function() {
    ...
    function y(t, a) {
        ...
        if ("media$thumbnail" in t[a]) {
            var i = t[a].media$thumbnail.url,
                ...
                o = i.replace("/s72-c", "/w100"); - 1 < s.indexOf("youtube.com/embed") && (l = i.replace("/default.", "/hqdefault."), n = i.replace("/default.", "/mqdefault."), o = i)
    ...
    function n(b, w, t, x) {
        if (w.match("mega-menu") || w.match("hot-posts") || w.match("feat-big") || w.match("col-left") || w.match("col-right") || w.match("videos-items") || w.match("grid-big") || w.match("feat-list") || w.match("post-list") || w.match("related")) {
            var a = "";
            ...
            $.ajax({
                ...
                success: function(t) {
                    ...
                    else if (w.match("videos-items")) a = '<ul class="videos-items">';
                    ...
                    if (null != o) {
                        for (var c = 0, r = o; c < r.length; c++) {
                            var m = k(r, c),
                                ...
                                u = (s = void 0, s = r[c].published.$t, i = s.substring(0, 4), l = s.substring(5, 7), n = s.substring(8, 10), '<span class="post-date">' + monthFormat[parseInt(l, 10) - 1] + " " + n + ", " + i + "</span>"),
                                g = (void 0, e = r[c].content.$t, '<p class="post-snippet">' + $("<div>").html(e).text().trim().substr(0, 86) + "…</p>"),
                                v = "";
w.match("mega-menu") ? v += ' <div class="mega-item item-' + c + '"> <div class="mega-content"> <div class="post-image-wrap"><a class="post-image-link" href="' + m + '">' + d[1] + '</a></div> <h2 class="post-title">' + h + '</h2> <div class="post-meta">' + u + "</div> </div> </div>" : w.match("hot-posts") ? v += 0 == c ? ' <li class="hot-item item-' + c + '"> <div class="hot-item-inner"><a class="post-image-link" href="' + m + '">' + d[0] + '</a> <div class="post-info">' + p + ' <h2 class="post-title">' + h + '</h2> <div class="post-meta">' + f + u + "</div> </div> </div> </li>" : ' <li class="hot-item item-' + c + '"> <div class="hot-item-inner"><a class="post-image-link" href="' + m + '">' + d[0] + '</a> <div class="post-info">' + p + ' <h2 class="post-title">' + h + '</h2> <div class="post-meta">' + u + "</div> </div> </div> </li>" : w.match("feat-big") ? v += 0 == c ? ' <li class="feat-item item-big item-' + c + '"> <div class="feat-inner"><a class="post-image-link" href="' + m + '">' + d[0] + "</a>" + p + ' <div class="post-info"> <h2 class="post-title">' + h + '</h2> <div class="post-meta">' + f + u + "</div>" + g + "</div> </div> </li>" : ' <li class="feat-item item-small item-' + c + '"><a class="post-image-link" href="' + m + '">' + d[1] + '</a> <div class="post-info"> <h2 class="post-title">' + h + '</h2> <div class="post-meta">' + u + "</div> </div> </li>" : w.match("col-left") || w.match("col-right") ? v += 0 == c ? ' <li class="feat-item item-big item-' + c + '"> <div class="feat-inner"><a class="post-image-link" href="' + m + '">' + d[0] + "</a>" + p + ' <div class="post-info"> <h2 class="post-title">' + h + '</h2> <div class="post-meta">' + f + u + "</div>" + g + "</div> </div> </li>" : ' <li class="feat-item item-small item-' + c + '"><a class="post-image-link" href="' + m + '">' + d[2] + '</a> <div class="post-info"> <h2 class="post-title">' + h + '</h2> <div class="post-meta">' + u + "</div> </div> </li>" : w.match("videos-items") ? v += ' <li class="feat-item item-small item-' + c + '"><a class="post-image-link" href="' + m + '">' + d[1] + '</a><span class="video-icon"></span> <div class="post-info"> <h2 class="post-title">' + h + '</h2> <div class="post-meta">' + u + "</div> </div> </li>" : w.match("grid-big") ? v += ' <li class="feat-item item-big item-' + c + '"> <div class="feat-inner"><a class="post-image-link" href="' + m + '">' + d[0] + "</a>" + p + ' <div class="post-info"> <h2 class="post-title">' + h + '</h2> <div class="post-meta">' + f + u + "</div> </div> </li>" : w.match("feat-list") ? v += ' <li class="feat-item item-' + c + '"> <div class="feat-inner"><a class="post-image-link" href="' + m + '">' + d[0] + "</a>" + p + ' <div class="post-info"> <h2 class="post-title">' + h + '</h2> <div class="post-meta">' + f + u + "</div>" + g + "</div> </div> </li>" : w.match("post-list") ? v += ' <li class="item-' + c + '"><a class="post-image-link" href="' + m + '">' + d[0] + "</a>" + p + ' <h2 class="post-title">' + h + '</h2> <div class="post-meta">' + u + "</div> </div> </li>" : w.match("related") && (v += ' <li class="related-item item-' + c + '"><a class="post-image-link" href="' + m + '">' + d[1] + '</a> <h2 class="post-title">' + h + '</h2> <div class="post-meta">' + u + "</div> </li>"), a += v

                        }
                        a += "</ul>"
                    } else a = '<ul class="no-posts">Error: No Posts Found <i class="fa fa-frown-o"/></ul>';
                    w.match("mega-menu") ? (b.addClass("has-sub mega-menu").append(a), b.find("a:first").attr("href", function(t, a) {
                        return a = "recent" == x || "random" == x ? a.replace(a, "/search/?&max-results=" + postPerPage) : a.replace(a, "/search/label/" + x + "?&max-results=" + postPerPage)
                    })) : w.match("hot-posts") ? b.html(a).parent().addClass("show-hot") : w.match("feat-big") || w.match("feat-list") || w.match("col-left") || w.match("col-right") || w.match("videos-items") || w.match("grid-big") ? (b.parent().find(".widget-title").append('<a class="view-all" href="/search/label/' + x + "?&max-results=" + postPerPage + '">' + messages.viewAll + "</a>"), (w.match("col-left") || w.match("col-right")) && (w.match("col-right") && b.parent().addClass("col-right"), b.parent().addClass("col-width")), b.html(a).parent().addClass("show-widget")) : b.html(a)
                }
            })
        }
    }

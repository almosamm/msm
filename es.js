...
$(document).ready(function() {
	(function(e) {
		...
		e.get(t.attr("href"), function(n) {
			t.html(
				' <strong> Siguiente tema <i class="lnr lnr-arrow-right"></i></strong><br/><div class="post-pager-title"><span>' +
				e(n).find(".post .post-title").text() + '</span></div>')
		}, "html");
		e.get(n.attr("href"), function(t) {
			n.html(
				'<strong><i class="lnr lnr-arrow-left"></i> Tema anterior </strong><br/><div class="post-pager-title"><span>' +
...
// This is function to activate Facebook Box
$(".widget-content").each(function() {
		var e = $(this).text();
		if (e.substr(0, 10).match("fbbox")) {
			e = e.replace("fbbox/", "");
			$(this).html('<iframe allowtransparency="true" frameborder="0" scrolling="no" src="//www.facebook.com/plugins/likebox.php?href=' + e + '&width=340px&height=258&colorscheme=light&show_faces=true&header=false&stream=false&show_border=false&appId=492409184153294" style="border:none; overflow:hidden; width:100%; height:182px;"></iframe>')
	}
});

// This is function to activate ads
$(function() {
...
// This is function to activate Scroll bar
$(function() {
...
// This is function to activate Pagination Pages
    var postperpage=9;
    var numshowpage=3;
    var upPageWord ='Previo';
    ...
    function loophalaman(banyakdata) {
    	...
    	html += "<span class='showpageOf'>Página " + nomerhal + ' de ' + maksimal + "</span>";
